...
## Required software
Most of the required software is in the ``requirements.txt`` file. [Networkx-METIS](https://networkx-metis.readthedocs.io/en/latest/index.html) can be installed by
```
...
```
see also the [installing page](https://networkx-metis.readthedocs.io/en/latest/install.html). You also need to build AMD and Scotch yourself.
